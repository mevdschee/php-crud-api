            ...
            foreach ($config->getControllers() as $controller) {
                switch ($controller) {
                    ...
                    case 'cache':
                        ...
                        break;
                    case 'openapi':
                        $openApi = new OpenApiService($reflection, $config, $router->getBasePath());
...
namespace Tqdev\PhpCrudApi\Cache {
    ...
    class TempFileCache extends BaseCache implements Cache
    {
        ...
        private function clean(string $path, array $segments, int $len, bool $all)
        {
...
namespace Tqdev\PhpCrudApi\Column\Reflection {
    ...
    class ReflectedColumn implements \JsonSerializable
    {
        ...
        {
            $json = ['name' => $this->realName, 'alias' => $this->name != $this->realName ? $this->name : null, 'type' => $this->type, 'length' => $this->length, 'precision' => $this->precision, 'scale' => $this->scale, 'nullable' => $this->nullable, 'pk' => $this->pk, 'fk' => $this->fk];
...
namespace Tqdev\PhpCrudApi\Column\Reflection {
    ...
    class ReflectedDatabase implements \JsonSerializable
    {
        ...
        public function serialize()
        {
            return ['types' => $this->tableTypes, 'realNames' => $this->tableRealNames];
        }
        #[\ReturnTypeWillChange]
        public function jsonSerialize()
        {
...
namespace Tqdev\PhpCrudApi\Column\Reflection {
    ...
    class ReflectedTable implements \JsonSerializable
    {
        ...
        public function serialize()
        {
            $json = ['name' => $this->realName, 'alias' => $this->name != $this->realName ? $this->name : null, 'type' => $this->type, 'columns' => array_values($this->columns)];
            return array_filter($json);
        }
        #[\ReturnTypeWillChange]
        public function jsonSerialize()
...
namespace Tqdev\PhpCrudApi\Controller {
    ...
    class StatusController
    {
        ...
        {
            $result = ['db' => $this->db->ping(), 'cache' => $this->cache->ping()];
            return $this->responder->success($result);
        }
    }
}
...
namespace Tqdev\PhpCrudApi\Database {
    ...
    class GenericDB
    {
        ...
        {
            return md5(json_encode([$this->driver, $this->address, $this->port, $this->database, $this->tables, $this->mapping, $this->username]));
        }
    }
}
...
namespace Tqdev\PhpCrudApi\Database {
    class LazyPdo extends \PDO
    {
        ...
        public function addInitCommand(string $command)
        {
...
namespace Tqdev\PhpCrudApi\Database {
    class TypeConverter
    {
        ...
        private $fromJdbc = ['mysql' => ['clob' => 'longtext', 'boolean' => 'tinyint(1)', 'blob' => 'longblob', 'timestamp' => 'datetime'], 'pgsql' => ['clob' => 'text', 'blob' => 'bytea', 'float' => 'real', 'double' => 'double precision', 'varbinary' => 'bytea'], 'sqlsrv' => ['boolean' => 'bit', 'varchar' => 'nvarchar', 'clob' => 'ntext', 'blob' => 'image', 'time' => 'time(0)', 'timestamp' => 'datetime2(0)', 'double' => 'float', 'float' => 'real']];
        private $toJdbc = [
            'simplified' => ['char' => 'varchar', 'longvarchar' => 'clob', 'nchar' => 'varchar', 'nvarchar' => 'varchar', 'longnvarchar' => 'clob', 'binary' => 'varbinary', 'longvarbinary' => 'blob', 'tinyint' => 'integer', 'smallint' => 'integer', 'real' => 'float', 'numeric' => 'decimal', 'nclob' => 'clob', 'time_with_timezone' => 'time', 'timestamp_with_timezone' => 'timestamp'],
            'mysql' => ['tinyint(1)' => 'boolean', 'bit(1)' => 'boolean', 'tinyblob' => 'blob', 'mediumblob' => 'blob', 'longblob' => 'blob', 'tinytext' => 'clob', 'mediumtext' => 'clob', 'longtext' => 'clob', 'text' => 'clob', 'mediumint' => 'integer', 'int' => 'integer', 'polygon' => 'geometry', 'point' => 'geometry', 'linestring' => 'geometry', 'multipoint' => 'geometry', 'multilinestring' => 'geometry', 'multipolygon' => 'geometry', 'datetime' => 'timestamp', 'year' => 'integer', 'enum' => 'varchar', 'set' => 'varchar', 'json' => 'clob'],
            'pgsql' => [
                'bigserial' => 'bigint',
                'bit varying' => 'bit',
                'box' => 'geometry',
            ...
            'sqlsrv' => ['varbinary()' => 'blob', 'bit' => 'boolean', 'datetime' => 'timestamp', 'datetime2' => 'timestamp', 'float' => 'double', 'image' => 'blob', 'int' => 'integer', 'money' => 'decimal', 'ntext' => 'clob', 'smalldatetime' => 'timestamp', 'smallmoney' => 'decimal', 'text' => 'clob', 'timestamp' => 'binary', 'udt' => 'varbinary', 'uniqueidentifier' => 'char', 'xml' => 'clob'],
            'sqlite' => ['tinytext' => 'clob', 'text' => 'clob', 'mediumtext' => 'clob', 'longtext' => 'clob', 'mediumint' => 'integer', 'int' => 'integer', 'bigint' => 'bigint', 'int2' => 'smallint', 'int4' => 'integer', 'int8' => 'bigint', 'double precision' => 'double', 'datetime' => 'timestamp'],
        ];
...
namespace Tqdev\PhpCrudApi\GeoJson {
    class Feature implements \JsonSerializable
    {
        ...
        public function serialize()
        {
            return ['type' => 'Feature', 'id' => $this->id, 'properties' => $this->properties, 'geometry' => $this->geometry];
        }
        #[\ReturnTypeWillChange]
        public function jsonSerialize()
        {
...
namespace Tqdev\PhpCrudApi\GeoJson {
    class FeatureCollection implements \JsonSerializable
    {
        ...
        public function serialize()
        {
            return ['type' => 'FeatureCollection', 'features' => $this->features, 'results' => $this->results];
        }
        #[\ReturnTypeWillChange]
        public function jsonSerialize()
        {
...
namespace Tqdev\PhpCrudApi\GeoJson {
    ...
    class GeoJsonService
    {
        ...
        private function convertRecordToFeature(
            /*object*/
            $record,
...
namespace Tqdev\PhpCrudApi\GeoJson {
    class Geometry implements \JsonSerializable
    {
        private $type;
        private $coordinates;
        public static $types = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"];
...
namespace Tqdev\PhpCrudApi\Middleware {
    ...
    class AuthorizationMiddleware extends Middleware
    {
        ...
        private function handleColumns(string $operation, string $tableName)
        {
        ...
        private function handleTable(string $operation, string $tableName)
        {
            if (!$this->reflection->hasTable($tableName)) {
                return;
            }
        ...
        private function handleRecords(string $operation, string $tableName)
        {
            if (!$this->reflection->hasTable($tableName)) {
                return;
            }
        ...
        private function pathHandler(string $path)
        {
...
namespace Tqdev\PhpCrudApi\Middleware {
    ...
    class IpAddressMiddleware extends Middleware
    {
        ...
        private function callHandler(ServerRequestInterface $request, $record, string $operation, ReflectedTable $table)
        {
...
namespace Tqdev\PhpCrudApi\Middleware {
    ...
    {
        private function convertJsonRequestValue($value)
        {
        ...
        private function convertJsonRequest($object, array $columnNames)
        {
            if (is_array($object)) {
        ...
        private function convertJsonResponseValue(string $value)
        {
        ...
        private function convertJsonResponse($object, array $columnNames)
        {
            if (is_array($object)) {
                foreach ($object as $k => $v) {
        ...
        public function process(ServerRequestInterface $request, RequestHandlerInterface $next): ResponseInterface
        {
            ...
            if ((in_array('all', $controllerPaths) || in_array($controllerPath, $controllerPaths)) && (in_array('all', $tableNames) || in_array($tableName, $tableNames))) {
...
namespace Tqdev\PhpCrudApi\Middleware {
    ...
    class JwtAuthMiddleware extends Middleware
    {
        ...
        {
            $algorithms = array('HS256' => 'sha256', 'HS384' => 'sha384', 'HS512' => 'sha512', 'RS256' => 'sha256', 'RS384' => 'sha384', 'RS512' => 'sha512');
            $token = explode('.', $token);
            if (count($token) < 3) {
                return array();
            }
            ...
            foreach ($requirements as $field => $values) {
                if (!empty($values)) {
                    if ($field != 'alg') {
                        ...
                        } else if (!in_array($claims[$field], $values)) {
                            return array();
                        }
                    }
                }
        ...
        private function getClaims(string $token): array
        {
            ...
            $requirements = array('alg' => $this->getArrayProperty('algorithms', ''), 'aud' => $this->getArrayProperty('audiences', ''), 'iss' => $this->getArrayProperty('issuers', ''));
...
namespace Tqdev\PhpCrudApi\Middleware {
    ...
    class SanitationMiddleware extends Middleware
    {
        ...
        private function callHandler($handler, $record, string $operation, ReflectedTable $table)
        {
            $context = (array) $record;
            $tableName = $table->getName();
        ...
        private function sanitizeType(ReflectedTable $table, ReflectedColumn $column, $value)
        {
            ...
            if ((in_array('all', $tables) || in_array($table->getName(), $tables)) && (in_array('all', $types) || in_array($column->getType(), $types))) {
                if (is_null($value)) {
                    return $value;
                }
                if (is_string($value)) {
            ...
            if ((in_array('all', $tables) || in_array($table->getName(), $tables)) && (in_array('all', $types) || in_array($column->getType(), $types))) {
                ...
                if (is_string($value)) {
                    ...
                    switch ($column->getType()) {
                        case 'integer':
                        case 'bigint':
                            if (filter_var($value, FILTER_SANITIZE_NUMBER_INT) !== $value || filter_var($value, FILTER_VALIDATE_INT) === false) {
                        ...
                        case 'float':
                        case 'double':
                            if (filter_var($value, FILTER_SANITIZE_NUMBER_FLOAT) !== $value || filter_var($value, FILTER_VALIDATE_FLOAT) === false) {
    ...
    class WpAuthMiddleware extends Middleware
    {
        ...
        public function process(ServerRequestInterface $request, RequestHandlerInterface $next): ResponseInterface
        {
            ...
            if ($method == 'POST' && $path == 'login') {
                ...
                $username = isset($body->{$usernameFormFieldName}) ? $body->{$usernameFormFieldName} : '';
                $password = isset($body->{$passwordFormFieldName}) ? $body->{$passwordFormFieldName} : '';
                $user = wp_signon(['user_login' => $username, 'user_password' => $password, 'remember' => false]);
                if ($user->ID) {
...
namespace Tqdev\PhpCrudApi\OpenApi {
    ...
    class OpenApiBuilder
    {
        ...
        private $builders;
        private $basePath;
        private $errors = [401 => "authentication required", 403 => "operation forbidden", 404 => "table, column or record not found", 405 => "operation not supported", 409 => "duplicate key or data integrity violation", 422 => "input could not be processed", 424 => "one or more operations of the batch failed", 500 => "internal server error"];
        ...
        private function setComponentErrors()
        {
...
// file: src/Tqdev/PhpCrudApi/OpenApi/OpenApiColumnTypes.php
namespace Tqdev\PhpCrudApi\OpenApi {
    use Tqdev\PhpCrudApi\Column\Reflection\ReflectedColumn;
    /**
    ...
    class OpenApiColumnTypes
    {
        private $types = [
            ...
            'varchar' => ['type' => 'string'],
            'clob' => ['type' => 'string', 'format' => 'large-string'],
            //custom format
            'varbinary' => ['type' => 'string', 'format' => 'byte'],
            'blob' => ['type' => 'string', 'format' => 'large-byte'],
            //custom format
            ...
            'geometry' => ['type' => 'string', 'format' => 'geometry'],
            //custom format
            'boolean' => ['type' => 'boolean'],
        ];
        private $ranges = ['integer' => ['minimum' => -2147483648, 'maximum' => 2147483647], 'bigint' => ['minimum' => -9223372036854775807 - 1, 'maximum' => 9223372036854775807]];
...
namespace Tqdev\PhpCrudApi\OpenApi {
    ...
    class OpenApiColumnsBuilder
    {
        private $openapi;
        private $middlewares;
        private $errors = ['database' => ['read' => []], 'table' => ['create' => [409], 'read' => [404], 'update' => [404], 'delete' => [404]], 'column' => ['create' => [404, 409], 'read' => [404], 'update' => [404], 'delete' => [404]]];
        private $operations = ['database' => ['read' => 'get'], 'table' => [
            'create' => 'post',
            'read' => 'get',
            'update' => 'put',
            //rename
            'delete' => 'delete',
        ], 'column' => ['create' => 'post', 'read' => 'get', 'update' => 'put', 'delete' => 'delete']];
        public function __construct(OpenApiDefinition $openapi, OpenApiMiddlewares $middlewares)
        {
            $this->openapi = $openapi;
            $this->middlewares = $middlewares;
        ...
        private function setPaths()
        {
            foreach (array_keys($this->operations) as $type) {
                foreach ($this->operations[$type] as $operation => $method) {
                    ...
                    $statusCodes = array_merge($this->errors[$type][$operation], $this->middlewares->getStatusCodes(), [500]);
                    sort($statusCodes);
                    foreach ($statusCodes as $statusCode) {
                        $this->openapi->set("paths|{$path}|{$method}|responses|{$statusCode}|\$ref", "#/components/responses/error-{$statusCode}");
                    }
        ...
        private function setComponentSchema()
        {
            foreach (array_keys($this->operations) as $type) {
        ...
        private function setComponentRequestBody()
        {
            foreach (array_keys($this->operations) as $type) {
                foreach (array_keys($this->operations[$type]) as $operation) {
                    if (!in_array($operation, ['create', 'update'])) {
...
// file: src/Tqdev/PhpCrudApi/OpenApi/OpenApiDbAuthBuilder.php
namespace Tqdev\PhpCrudApi\OpenApi {
    use Tqdev\PhpCrudApi\Column\ReflectionService;
    use Tqdev\PhpCrudApi\OpenApi\OpenApiDefinition;
    /**
    ...
    class OpenApiDbAuthBuilder
    {
        ...
        private $columnTypes;
        private $tag = 'dbAuth';
        private $operations = ['login' => ['post', 'log a user in with a username and a password', [403]], 'logout' => ['post', 'log the current user out', [401]], 'register' => ['post', 'register a new user', [403, 409, 422]], 'password' => ['post', 'change the password of the current user', [403, 422]], 'me' => ['get', 'read the user that is currently logged in', [401]]];
        ...
        private function getFormFields(): array
        {
            ...
            return ['login' => [$username => false, $password => true], 'register' => [$username => false, $password => true], 'password' => [$username => false, $password => true, $newPassword => true]];
        }
        ...
        private function setComponentRequestBodies()
        {
...
namespace Tqdev\PhpCrudApi\OpenApi {
    class OpenApiDefinition implements \JsonSerializable
    {
         ...
         */
        public function copyContentType(string $from, string $to)
        {
            $this->copyContentTypeIn($this->root, $from, $to);
        }
        private function copyContentTypeIn(array &$node, string $from, string $to)
        {
...
namespace Tqdev\PhpCrudApi\OpenApi {
    ...
    class OpenApiRecordsBuilder
    {
         ...
         */
        private function setSingleOrBatchSchema(string $prefix, string $schema)
        {
            $this->openapi->set("{$prefix}|content|application/json|schema|oneOf|0|\$ref", $schema);
         ...
         * a single value.
         */
        private function setBatchableResponse(string $name, string $description, array $schema)
        {
...
namespace Tqdev\PhpCrudApi\OpenApi {
    ...
    class OpenApiStatusBuilder
    {
        private $openapi;
        private $middlewares;
        private $operations = ['status' => ['ping' => 'get']];
        public function __construct(OpenApiDefinition $openapi, OpenApiMiddlewares $middlewares)
        {
            $this->openapi = $openapi;
            $this->middlewares = $middlewares;
...
namespace Tqdev\PhpCrudApi\Record {
    ...
    class ColumnIncluder
    {
        ...
        private function select(string $tableName, bool $primaryTable, array $params, string $paramName, array $columnNames, bool $include): array
        {
            ...
            foreach ($columnNames as $columnName) {
                ...
                } else if (!$include || $this->isMandatory($tableName, $columnName, $params)) {
                    $result[] = $columnName;
                }
            }
            return $result;
...
namespace Tqdev\PhpCrudApi\Record\Condition {
    ...
    abstract class Condition
    {
        ...
        public static function fromString(ReflectedTable $table, string $value): Condition
        {
            ...
            } else if (in_array($command, ['cs', 'sw', 'ew', 'eq', 'lt', 'le', 'ge', 'gt', 'bt', 'in', 'is'])) {
...
namespace Tqdev\PhpCrudApi\Record\Document {
    ...
    class ErrorDocument implements \JsonSerializable
    {
        ...
        public function serialize()
        {
            return ['code' => $this->getCode(), 'message' => $this->getMessage(), 'details' => $this->details];
        }
        #[\ReturnTypeWillChange]
        public function jsonSerialize()
        {
...
namespace Tqdev\PhpCrudApi\Record\Document {
    class ListDocument implements \JsonSerializable
    {
        ...
        public function serialize()
        {
            return ['records' => $this->records, 'results' => $this->results];
        }
        #[\ReturnTypeWillChange]
        public function jsonSerialize()
        {
