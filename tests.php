...
class MySQL_CRUD_API_Test extends PHPUnit_Framework_TestCase
{
	...
	public function testListWithPaginate()
	{
		...
		$test->expect('{"posts":{"columns":["id","user_id","category_id","content"],"records":[["4","1","1","#1"],["5","1","1","#2"]],"results":12}}');
	}
	...
	public function testListWithPaginateLastPage()
	{
		...
		$test->expect('{"posts":{"columns":["id","user_id","category_id","content"],"records":[["12","1","1","#9"],["13","1","1","#10"]],"results":12}}');
	}
	...
	public function testListExampleFromReadmeWithTransform()
	{
		...
		$test->expect('{"posts":[{"id":"1","post_tags":[{"id":"1","post_id":"1","tag_id":"1","tags":[{"id":"1","name":"funny"}]},{"id":"2","post_id":"1","tag_id":"2","tags":[{"id":"2","name":"important"}]}],"comments":[{"id":"1","post_id":"1","message":"great"},{"id":"2","post_id":"1","message":"fantastic"}],"user_id":"1","category_id":"1","categories":[{"id":"1","name":"anouncement"}],"content":"blog started"}]}');
	}
