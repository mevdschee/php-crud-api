...
CREATE TABLE "alltypes" (
  ...
  nnvarchar text NOT NULL ,
  nndecimal numeric NOT NULL ,
  nnfloat real NOT NULL ,
  nndouble real NOT NULL ,
  nnboolean numeric NOT NULL ,
  nndate text NOT NULL ,
  nntime text NOT NULL ,
  nntimestamp text NOT NULL ,
  nnclob text NOT NULL ,
  nnblob blob NOT NULL ,
  nnvarbinary blob NOT NULL ,
  nngeometry text NOT NULL ,
