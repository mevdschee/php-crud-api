...
IF (OBJECT_ID('alltypes_id_def') IS NOT NULL)
BEGIN
ALTER TABLE [dbo].[alltypes]
DROP CONSTRAINT alltypes_id_def
END
...
CREATE TABLE alltypes (
	...
	[nnclob] [nvarchar](1000) NOT NULL ,
	[nnblob] [nvarchar](1000) NOT NULL ,
	[nnvarbinary] [varbinary](20) NOT NULL ,
...
INSERT [alltypes] (
	...
	0xa,
	0xa,
	geometry::STGeomFromText('POINT(1 1)', 4326),
	NULL,
	NULL,
	NULL
)
